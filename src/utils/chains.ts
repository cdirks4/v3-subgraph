...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == ARBITRUM_ONE_NETWORK_NAME) {
  ...
  } else if (selectedNetwork == STORY_TESTNET_NAME) {
    return {
      factoryAddress: '0x2D1bc93A4d0C23047577ac16C7Fe5CfEAb62B87B',
      stablecoinWrappedNativePoolAddress: '0x8d6934472ea18591f4de85bd04110e2d152e2a11', // WETH-USDbC 0.05% pool
      stablecoinIsToken0: false,
      wrappedNativeAddress: '0x968B9a5603ddEb2A78Aa08182BC44Ece1D9E5bf0', // WETH
    ...
    return {
      factoryAddress: '0x82FFccAa0d16C8FB0C5A433Ffec709A2fbCa3cB9',
